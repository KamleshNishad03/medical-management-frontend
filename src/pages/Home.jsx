...
//                 icon: "🚚",
//                 title: "Fast Delivery",
//                 desc: "Same day delivery available in your city",
//               },
//               {
//                 icon: "✅",
//                 title: "Genuine Medicines",
//                 desc: "100% authentic medicines from trusted brands",
//               },
//               {
//                 icon: "💰",
//                 title: "Best Prices",
//                 desc: "Lowest prices with exclusive offers and discounts",
//               },
//               {
//                 icon: "👨‍⚕️",
//                 title: "Expert Support",
//                 desc: "Medical experts available for guidance",
//               },
//             ].map((item, i) => (
...
//                 icon: "💧",
//                 title: "Stay Hydrated",
//                 desc: "Drink at least 8 glasses of water daily. Proper hydration helps in digestion, skin health and overall body function.",
//               },
//               {
//                 icon: "🥗",
//                 title: "Balanced Diet",
//                 desc: "Include fruits, vegetables, proteins and whole grains in your daily diet. Avoid processed and junk food as much as possible.",
//               },
//               {
//                 icon: "🏃",
//                 title: "Regular Exercise",
//                 desc: "At least 30 minutes of physical activity daily keeps heart disease, diabetes and obesity at bay.",
//               },
//               {
//                 icon: "😴",
//                 title: "Proper Sleep",
//                 desc: "7-8 hours of quality sleep is essential for mental health, immunity and overall body recovery.",
//               },
//               {
//                 icon: "💊",
//                 title: "Take Medicines on Time",
//                 desc: "Always take prescribed medicines on time. Never skip doses and consult your doctor before stopping any medication.",
//               },
//               {
//                 icon: "🩺",
//                 title: "Regular Checkups",
//                 desc: "Get regular health checkups done even if you feel healthy. Early detection of disease leads to better treatment.",
//               },
//             ].map((tip, i) => (
//               <div
//                 key={i}
...
//             services ko ek hi jagah par access karne ki suvidha deta hai. Hamara
//             vision hai ki har ghar tak quality healthcare pahunche — affordable,
//             fast aur trusted tarike se.
//           </p>
...
//                 Kisi bhi medicine ya order related query ke liye directly call
//                 karein.
//               </p>
...
//           © 2026 ApnaCare. All rights reserved. Made with ❤️ for better
//           healthcare.
//         </div>
//       </main>
//       <BottomNav />
...
const Home = ({ openLoginModal }) => {
  ...
  return (
    // FIX: overflow-x-hidden on root div prevents horizontal scroll on all screens
    <div className="min-h-screen bg-[#f6fff7] pb-24 lg:pb-0 overflow-x-hidden">
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 md:py-8 space-y-8">
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-6 items-start">
          <section className="space-y-6">
            <div className="rounded-[28px] bg-gradient-to-br from-green-600 to-green-500 text-white p-5 md:p-8 shadow-lg">
              ...
              {/* FIX: flex-wrap + overflow-x-hidden prevents category buttons from overflowing */}
              <div className="mt-5 flex flex-wrap gap-2 overflow-x-hidden">
                {categories.map((item) => (
                  <button
                    key={item}
                    onClick={() => setSelectedCategory(item)}
            ...
            <div className="rounded-[28px] bg-gradient-to-r from-orange-500 to-orange-400 text-white p-5 md:p-6 shadow-md flex items-center justify-between gap-4">
              <div className="min-w-0">
                <p className="text-sm opacity-90">Limited Time Offer</p>
                <h2 className="text-xl md:text-3xl font-bold mt-1">Extra Savings</h2>
                <p className="text-xs md:text-sm mt-1">
                  Best prices on medicines with fast home delivery
                </p>
              </div>
              <div className="w-16 h-16 md:w-24 md:h-24 shrink-0 rounded-full bg-white/20 flex items-center justify-center text-3xl">
                💊
              </div>
            </div>
          </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg md:text-2xl font-bold text-gray-800">Popular Medicines</h2>
            <span className="text-green-600 font-semibold text-sm md:text-base shrink-0 ml-2">
              {filteredProducts.length} Items
            </span>
          </div>
        ...
        <section className="bg-white rounded-[30px] shadow-md p-6 md:p-8">
          ...
          {/* FIX: grid-cols-2 on mobile instead of 4 — prevents cramping */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {[
              ...
              <div key={i} className="bg-green-50 rounded-2xl p-3 md:p-4 text-center">
                <div className="text-2xl md:text-3xl mb-2">{item.icon}</div>
                <h3 className="font-bold text-gray-800 text-xs md:text-sm">{item.title}</h3>
                <p className="text-[10px] md:text-xs text-gray-500 mt-1 leading-4">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-white rounded-[30px] shadow-md p-6 md:p-8">
          ...
          {/* FIX: w-full on each card + break-words + smaller font on mobile */}
          <div className="grid grid-cols-3 gap-2 md:gap-4 mt-6">
            <div className="text-center bg-green-50 rounded-2xl p-3 md:p-4 min-w-0">
              <p className="text-lg md:text-2xl font-extrabold text-green-600 break-words">500+</p>
              <p className="text-[10px] md:text-xs text-gray-500 mt-1 leading-tight">Medicines Available</p>
            </div>
            <div className="text-center bg-orange-50 rounded-2xl p-3 md:p-4 min-w-0">
              <p className="text-lg md:text-2xl font-extrabold text-orange-500 break-words">1000+</p>
              <p className="text-[10px] md:text-xs text-gray-500 mt-1 leading-tight">Happy Customers</p>
            </div>
            <div className="text-center bg-blue-50 rounded-2xl p-3 md:p-4 min-w-0">
              <p className="text-lg md:text-2xl font-extrabold text-blue-500 break-words">24/7</p>
              <p className="text-[10px] md:text-xs text-gray-500 mt-1 leading-tight">Support Available</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-[30px] shadow-md p-6 md:p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* LEFT SIDE INFO */}
            {/* FIX: min-w-0 + break-words stops address from overflowing */}
              ...
              {[
                ...
                <div key={i} className="flex gap-3 items-start min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {/* FIX: break-words ensures long address/email wraps correctly */}
            ...
            <div className="bg-green-50 rounded-2xl p-5 space-y-4">
              ...
              <a
                href="tel:+918810891046"
                className="flex items-center gap-3 bg-green-600 text-white px-4 py-3 md:px-5 md:py-4 rounded-2xl hover:bg-green-700 active:scale-95 transition-all"
              >
                <span className="text-xl md:text-2xl shrink-0">📞</span>
                <div className="min-w-0">
                  <p className="text-xs opacity-80">Call Number 1</p>
                  <p className="text-base md:text-lg font-bold break-words">+91 8810891046</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-xs opacity-80">Call Number 2</p>
                  <p className="text-base md:text-lg font-bold break-words">+91 8874113875</p>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 bg-[#25D366] text-white px-4 py-3 md:px-5 md:py-4 rounded-2xl hover:opacity-90 active:scale-95 transition-all"
              >
                <span className="text-xl md:text-2xl shrink-0">💬</span>
                <div className="min-w-0">
                  <p className="text-xs opacity-80">Chat on WhatsApp</p>
              ...
              <a
                href="mailto:apnacare771@gmail.com"
                className="flex items-center gap-3 bg-orange-500 text-white px-4 py-3 md:px-5 md:py-4 rounded-2xl hover:bg-orange-600 active:scale-95 transition-all"
              >
                <span className="text-xl md:text-2xl shrink-0">📧</span>
                <div className="min-w-0">
                  <p className="text-xs opacity-80">Email Us</p>
                  <p className="text-base md:text-lg font-bold break-words">apnacare771@gmail.com</p>
                </div>
              </a>
            </div>
          </div>
